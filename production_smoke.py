...
def run_smoke(
    ...
    *,
    ...
    try:
        ...
        lifecycle_phase = str(components.get("runtime_lifecycle") or "missing")
        checks.append(SmokeCheck("runtime_lifecycle", "pass" if lifecycle_phase == "accepting" else "fail", lifecycle_phase))
