...
export default function Home() {
  ...
  return <>
    ...
    <main id="main">
      <section className="hero" id="top"><div className="heroCopy"><span className="pill">Privater Produkttest · Noch kein öffentlicher Dienst</span><p className="eyebrow">Der Alltagsheld für Deutschland</p><h1>Papierkram in Deutschland.<br/><em>Endlich verständlich.</em></h1><p className="lead">Sam ist dein KI-gestützter persönlicher Assistent in WhatsApp. Er hilft dir, Briefe zu verstehen, Termine zu ordnen, Nachrichten vorzubereiten und Fristen im Blick zu behalten – in deiner Sprache.</p>{betaEnabled ? <button className="cta">Closed Beta beitreten</button> : <a className="cta" href="#tools">Demo ansehen</a>}<p className="researchNote">Für diesen Produkttest brauchst du keine persönlichen Daten und keine echten Unterlagen. Die Closed Beta ist noch geschlossen.</p><div className="chips"><span>✓ Keine neue App</span><span>✓ 5 Sprachen</span><span>✓ Prüfbarkeit vor Handlung</span></div></div><div className="phone"><div className="phoneHead"><span className="avatar">S</span><div><strong>Sam von AmtHero24</strong><small>KI-gestützter Assistent</small></div></div><div className="bubble user">Ich habe diesen Brief bekommen. Was muss ich tun?</div><div className="doc">📄 Beispiel_Jobcenter.pdf</div><div className="bubble sam"><b>Das Wichtigste:</b><br/>Frist: 14 Tage<br/>Nächster Schritt: Unterlagen nachreichen<br/><small>Synthetisches Beispiel · wichtige Angaben immer am Original prüfen.</small></div></div></section>

      <section className="section validation"><p className="eyebrow">Wir testen gerade die Idee</p><h2>Hilf uns zu verstehen, ob AmtHero24 wirklich ein Problem löst.</h2><div className="grid3"><article><b>01</b><h3>Demo anschauen</h3><p>Schau dir die Seite und die kurzen Beispieldemos an. Es werden keine echten Fälle bearbeitet.</p></article><article><b>02</b><h3>Ehrlich sagen, was fehlt</h3><p>Was verstehst du sofort? Was wirkt unklar? Welche Alltagssituation wäre für dich am wichtigsten?</p></article><article><b>03</b><h3>Keine Anmeldung nötig</h3><p>Dieser Test ist reine Produktforschung. Keine Zahlung, kein Vertrag, keine Beta-Aufnahme und keine Dokumentenübermittlung.</p></article></div></section>
